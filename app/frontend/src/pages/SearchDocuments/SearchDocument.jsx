        ...
        <Container className={styles.container}>
                    ...
                    {searchByProcess ? (
                        <>
                            <Controller
                                ...
                                render={({ field }) => (
                                    <Autocomplete
                                        {...field}
                                        value={watch('processName') ? processNames.find((item) => item.name === watch('processName')) : {}}
                        ...
                        <>
                            <Controller
                                ...
                                control={control}
                                render={({ field }) => (
                                    <TextField {...field} className={styles.textField} label="Cabinet Number" fullWidth />
                                )}
                            />
                            <Controller
                                name="year"
                                control={control}
                                render={({ field }) => (
                                    <TextField {...field} className={styles.textField} label="Year" fullWidth />
                                )}
                            />
                            <Controller
                                name="departmentName"
            ...
            {results.length > 0 ? (
                <Stack spacing={2} mt={4}>
                    <Typography textAlign="end" variant="h6" fontWeight={600}>
                                ...
                                >
                                    ...
                                    {result.type === 'file' && (
                                        <Stack alignItems="flex-start">
                                            <Button
                                                onClick={() =>
                                                    handleView(result.path, result.name, result.documentId)
                                                }
                                                startIcon={<IconEye />}
                                            >
                                                View File
                                            </Button>
                                            <Button color='secondary' onClick={() => handleDownload(result.path, result.name)} startIcon={<IconDownload />}>Download</Button>
                                        </Stack>
                                    )}
                                </Stack>
                            </CardContent>
