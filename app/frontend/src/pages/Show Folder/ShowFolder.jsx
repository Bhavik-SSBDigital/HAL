...
export default function ShowFolder(props) {
    const isKeeperOfPhysicalDocs = sessionStorage.getItem('isKeeperOfPhysicalDocs') == "true";
    ...
    const handleTransferFile = async () => {
        ...
        try {
            ...
            setFileFolders((prev) => prev.map(item => item.id == properties.id ? { ...item, physicalHolder: transferData?.borrower } : item))
    ...
    return (
        <>
            {loading ? (
                ...
                <Stack>
                    ...
                    >
                        ...
                        <Box sx={{ backgroundColor: "white", padding: "8px", borderRadius: "15px", border: "1px solid lightgray", mb: 1 }}>
                            <Path />
                            <Stack
                                flexDirection="row"
                            ...
                            {loading === false &&
                                ...
                                !searchQuery && (
                                    <Stack
                                        ...
                                        width="100%"
                                        height="40vh"
                                        sx={{ backgroundColor: "white", borderRadius: "15px", border: '1px solid lightgray' }}
                                        alignItems="center"
                                    >
                                        <Typography>
            ...
            >
                <MenuItem
                    disabled={checkDownloadable(
                        properties?.isDownloadable ||
                        properties?.isInvolvedInProcess,
                    )}
                    sx={{ gap: '5px' }}
                    onClick={() => {
                ...
                {(isKeeperOfPhysicalDocs && !properties?.physicalHolder) && <MenuItem
                    sx={{ gap: '5px', width: "250px" }}
                    onClick={() => {
                        setTransfer(true);
                        handleClose();
            ...
            {open && (
                ...
                >
                    <div
                        style={{ gap: '10px', position: 'relative', width: "90%", maxWidth: '400px' }}
                ...
                >
                    <Paper elevation={0} sx={{ width: '100%', padding: '20px', display: 'flex', gap: "10px", flexDirection: "column", border: '1px solid lightgray' }}>
                        ...
                        <TextField
                            ...
                            disabled={!!fieldsLoading}
                            sx={{ backgroundColor: "whitesmoke" }}
                            onChange={(e) => setTransferData((prevData) => ({
                                ...prevData,
                        ...
                        >
                            {!fieldsLoading ? 'Transfer File' : <CircularProgress size={22} />}
                        </Button>
