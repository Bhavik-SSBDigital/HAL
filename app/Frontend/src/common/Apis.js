...
export const RecoverDeletedFile = async (documentId) => {
  return apiClient.post(`/recoverDeletedFile`, { documentId });
};
...
export const UnArchiveFile = async (documentId) => {
  return apiClient.post(`/unarchiveFile`, { documentId });
};
