...
import {
    download,
    upload,
} from "../../Components/Common/drop-file-input/FileUploadDownload";
...
export default function ViewProcess({ viewId, workflowFollow, setViewDetails }) {
    ...
    const details = [
        ...
        {
            label: "File Name",
            value: processData?.documents?.length <= 4 ? (
                <Stack flexDirection="row" gap={1} flexWrap="wrap">
                    {processData?.documents?.map((item, index) => {
                        ...
                        return (
                            <>
                                <Typography className={styles.workName} key={index} sx={{ border: "1px solid lightgray" }}>
                                    {work}
                                </Typography>
                            </>
                        );
    ...
    return (
        <>
            <Button onClick={() => setViewDetails(null)} startIcon={<IconArrowLeft />}>Processes</Button>
                                                                ...
                                                                >
                                                                    ...
                                                                    <div>
                                                                        <div className={styles.iconContainer}>
                                                                            <FileIcon size2={20} name={file?.details?.name} />
                                                                        </div>
                            ...
                            <Stack sx={{ padding: "5px" }}>
                                                ...
                                                return (
                                                    ...
                                                    >
                                                        ...
                                                        >
                                                                    ...
                                                                    {published != "true" && (
                                                                        ...
                                                                        >
                                                                            {file?.signedBy
                                                                                ...
                                                                                <Button color="success">Signed</Button>
                                                                            ) : (
                                                                                file?.rejection ? null : <Button color="error">Un-Signed</Button>
                                                                            )}
                                                                            {file?.rejection &&
                                                            ...
                                                            <div>
                                                                <div className={styles.iconContainer}>
                                                                    <FileIcon size2={22} name={file?.details?.name} />
                                                                </div>
                                                                <div className={styles.fileNameContainer}>
                                                                    <Tooltip
                                                                        title={file.details.name}
                                            ...
                                            >
                                                ...
                                                >
                                                    {processData?.workFlow
                                                        ...
                                                        .filter(
                                                            (item) =>
                                                                item.step <= processData?.maxReceiverStepNumber
                                                        )
                                                        .map((item) => (
                                ...
                                >
                                    <Box sx={style}>
                                        ...
                                        <Grid2 container spacing={4} sx={{ marginBottom: "10px" }}>
                                            <Grid2 item xs={12}>
                                                <TextField
                                                    fullWidth
                                                    select
                                                        ...
                                                        ?.map((branch) => (
                                                            <MenuItem
                                                                ...
                                                                style={{
                                                                    margin: "2px",
                                                                    backgroundColor:
                                                                        selectedBranch?.name?.includes(branch.name)
                                                                            ? "lightblue"
                                                                            : "initial",
                                                                }}
                                                            >
                                    ...
                                    {userNotFirstInWorkflow &&
                                        ...
                                        !processData?.completed && (
                                            <Button
                                                ...
                                                disabled={
                                                    // disableReject() ||
                                                    !processData.hasUserDoneAnythingAfterReceivingProcess ||
                                                    processData.completed ||
