        ...
        <>
            ...
            >
                <div className={styles['drop-file-input__label']}>
                    <IconCloudUpload color='#4E327E' size={35} style={{ marginLeft: "auto", marginRight: "auto" }} />
                    <Typography sx={{ fontSize: '16px', fontWeight: 'bold', color: "black", mt: 1 }}>
                        Drag & Drop files here
                    </Typography>
                    <Divider sx={{ my: 1 }}>OR</Divider>
                    <Typography variant='h6' sx={{ color: "blue", textDecoration: "underline" }}>Browse</Typography>
                </div>
                                                    ...
                                                    <Box sx={{ padding: '10px' }}>
                                                        ...
                                                        >
                                                            <Table>
                                                                <TableRow>
                                                                    <TableCell
                                                                        sx={{ border: '1px solid lightgray', fontWeight: 600 }}
                                                                    >
                                                                        SR_NO
                                                                    </TableCell>
                                                                    <TableCell
                                                        ...
                                                        <Stack flexDirection="row" justifyContent="center" mt={1}>
                                                            <Box>
                                                                <Button
                                                                    variant="contained"
                                                                    color="success"
