    ...
    <div className="fixed z-30 inset-0 flex items-center justify-center bg-black bg-opacity-50 backdrop-blur-sm">
      <div className="bg-gray-800 bg-white p-6 rounded-lg shadow-xl w-96">
        ...
        <div className="flex justify-end space-x-3 mt-5">
          <button
            className="px-4 py-2 bg-gray-600 hover:bg-gray-500 transition-all rounded-lg"
            onClick={onClose}
            disabled={isLoading}
          >
            Cancel
          ...
          <button
            className="px-4 py-2 bg-blue-600 hover:bg-blue-500 transition-all text-white rounded-lg"
            onClick={onConfirm}
            disabled={isLoading}
          >
