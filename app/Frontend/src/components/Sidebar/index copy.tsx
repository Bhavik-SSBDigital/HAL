        ...
        <nav className="py-3 px-1">
          ...
          <ul className="mb-6 flex flex-col gap-0.5 p-1">
            ...
            <NavLink
              ...
              className={`rounded-md group relative flex items-center gap-3 rounded-sm py-3 px-4 font-medium text-bodydark1 duration-300 ease-in-out hover:bg-gray-700 dark:hover:bg-meta-4 hover:text-white ${
